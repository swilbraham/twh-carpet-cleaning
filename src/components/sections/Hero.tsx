      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40 w-full">
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            Carpets So Clean,
            <br />
            <span className="text-accent-400">They Look Brand New</span>
          </motion.h1>
          ...
          >
            ...
            it&apos;s your home or business, we&apos;ll make every surface
            spotless.
          </motion.p>
