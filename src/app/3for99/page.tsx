...
export default function ThreeForNinetyNinePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(FORMSUBMIT_URL, {
        ...
        body: JSON.stringify({
          ...formData,
          _subject: `OFFER (3 Carpets £99) — ${formData.name}`,
          _template: "table",
        }),
      });
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.05] mb-6">
                  ...
                  <span className="text-accent-400">£99</span>
                </h1>

                <p className="text-lg text-white/80 mb-8 leading-relaxed max-w-lg">
                  Three carpets, one fixed price &mdash; that&apos;s a full £20
                  off our standard rate. Truck-mounted hot-water extraction,
                  eco-friendly products, NCCA-accredited technicians. Available
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-8 max-w-xl">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 flex flex-col justify-center">
                    ...
                    <p className="text-white/70 text-sm">
                      Save £20 vs our standard 3-carpet price. Fixed price, no
              ...
              >
                <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 relative">
                  {/* Offer ribbon */}
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-accent-500 text-white text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full shadow-lg whitespace-nowrap">
                    Claim £99 Offer
                  </div>
                  ...
                  {status === "success" ? (
                    <div ref={successRef} className="text-center py-10 scroll-mt-24">
                      ...
                      <p className="text-gray-600">
                        Thanks — we&apos;ll call you within 2 hours to lock in
                        your £99 clean.
                      </p>
                    </div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-4 pt-2">
                      <div className="text-center mb-1">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          3 carpets cleaned — save £20, no obligation
                        </p>
                      </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">
                ...
                <span className="text-brand-500">£99 Clean</span>
              </h2>
            ...
            <div className="mt-10 bg-brand-50 border border-brand-100 rounded-2xl p-6 text-center">
              <p className="text-sm text-gray-700">
                ...
                £99 offer applies to three standard domestic carpets in the same
                ...
                our standard service area. Cannot be combined with other
                offers.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">
                Ready to claim your{" "}
                <span className="text-accent-400">£99 offer?</span>
              </h2>
